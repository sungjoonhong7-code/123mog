    ...
    <div className="min-h-[80vh] flex items-center justify-center">
      <div className="text-center max-w-lg">
        ...
        <div className="flex gap-4 justify-center mt-8">
          ...
          <a href="/register" className="px-6 py-3 bg-white dark:bg-gray-800 text-emerald-600 border border-emerald-600 rounded-lg font-medium hover:bg-emerald-50 transition-colors">
            {t.home.register}
          </a>
        </div>
